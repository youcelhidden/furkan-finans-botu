...
def log_to_excel(data):
    save_to_json((euro, dolar, altin, borsa, bitcoin, gumus, brent))
...
def send_email(message):
    ...
    msg["Subject"] = "\U0001F4EC Günlük Piyasa Özeti"
...
🛢️ Brent: ${brent}"""
    ...
    log_to_json((euro, dolar, altin, borsa, bitcoin, gumus, brent))
